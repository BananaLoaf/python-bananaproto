...
async def generate_test_case_output(
    ...
    test_case_output_path_reference = test_case_input_path.joinpath(output_path_reference)
    test_case_output_path_bananaproto = test_case_input_path.joinpath(output_path_bananaproto)
    test_case_output_path_bananaproto_pyd = test_case_input_path.joinpath(output_path_bananaproto_pydantic)
